 ...
 * Mensajes Hechos:
 *
 * Plato listo | [Rtas Terminadas] BooleanasTerminado de codear respuestas booleanas
...
void enviarRespuestaBooleana(uint32_t socketCliente, codigo_operacion codOp, int valorRespuesta){
